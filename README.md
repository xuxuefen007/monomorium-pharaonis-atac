...
### `MZT_analysis.R`
**Quantitative analysis of maternal transcript clearance during the maternal-to-zygotic transition (MZT)**： This script performs a targeted quantitative analysis of maternal transcript clearance at the onset of the maternal-to-zygotic transition (MZT) using time-series RNA-seq data. It extracts transcript expression profiles from Salmon quantification files (`quant.sf`) across embryonic samples and focuses on the comparison between early developmental stages (0–12 h and 12–24 h).
